...
// sliderSwiperColumnImage.addEventListener('mousemove', handleStart);
// sliderSwiperColumnText.addEventListener('mousemove', handleStart);
// function handleStart(e) {
// 	e.preventDefault();
// 	return false;
// }

myImageSlider.onmousedown = function (e) {
	e.preventDefault();
	return false;
};

myTextSlider.onmousedown = function (e) {
	e.preventDefault();
	return false;
};